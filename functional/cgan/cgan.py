...
def make_generator_model():
    ...
    x = layers.Dense(7*7*256, use_bias=False)(in_lat)
    ...
    x = layers.BatchNormalization()(x)
    x = layers.LeakyReLU()(x)
    out_img = layers.Conv2DTranspose(1, (5, 5), strides=(2, 2), padding='same', use_bias=False, activation='tanh')(x)
...
def make_discriminator_model():
    in_img = layers.Input(shape=(28, 28, 1))
