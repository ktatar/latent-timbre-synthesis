...
#SBATCH --time=5-12:00      # time (DD-HH:MM)
...
#wait
python /home/ktatar/scratch/timbre-space/functional/timbre-cvae/train-with-nn-upsampling.py --config /home/ktatar/scratch/timbre-space/functional/timbre-cvae/default-cedar3.ini
