...
#SBATCH --time=1-18:00      # time (DD-HH:MM)
...
#wait
python /home/ktatar/scratch/timbre-space/functional/timbre-vae2/train.py --config /home/ktatar/scratch/timbre-space/functional/timbre-vae2/default-cedar.ini
