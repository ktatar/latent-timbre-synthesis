...
#SBATCH --time=4-02:00      # time (DD-HH:MM)
...
python /home/ktatar/scratch/latent-timbre-synthesis/utils/lspace_vis.py --config /home/ktatar/scratch/latent-timbre-synthesis/utils/lspace_vis.ini
